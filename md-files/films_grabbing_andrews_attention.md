# Films Grabbing the Author's Attention (Past and Present)

*A work in progress on what I watched leading up to Films from the Future (and why I chose or did not choose movies for the book), and what I’ve been watching since that's grabbed my attention. Note that there's also a file of films Claude thought I should have watched, but havent at [Claude Film Recommendations](https://spoileralert.wtf/html-files/claude_film_recommendations.html)!* 
...
This is not a list of science fiction movies that have a tech connection, although many do. Rather, in the spirit of the book Films from the Future, it's a list of films that have the potential to spark interesting and insightful conversations around emerging technologies, society, and the future. It's also very idiosyncratically "me" — movies that I enjoy, movies that I definitely did not enjoy but thought it worth mentioning, and movies that I'm sure some people will roll their eyes at but that I found value in anyway, even if it was just enjoying the luxury of chilling out while watching a mindless movie!
...
**Connects to:** [De-Extinction](https://spoileralert.wtf/md-files/est_de_extinction.md) · [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Jurassic Park film page](https://spoileralert.wtf/md-files/movies_jurassic_park.md)
...
**2010 · Mark Romanek**
*Status: In the book — Chapter 3*

**Key themes:** Cloning, human dignity, too valuable to fail, informed consent, deception/manipulation, what makes us human

**Connects to:** [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Too Valuable to Fail](https://spoileralert.wtf/md-files/rei_too_valuable_to_fail.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Never Let Me Go film page](https://spoileralert.wtf/md-files/movies_never_let_me_go.md)
...
**Connects to:** [Predictive Algorithms](https://spoileralert.wtf/md-files/est_predictive_algorithms.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Surveillance, Privacy, and Control](https://spoileralert.wtf/md-files/rei_surveillance_privacy_control.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Minority Report film page](https://spoileralert.wtf/md-files/movies_minority_report.md)
...
**2011 · Neil Burger**
*Status: In the book — Chapter 5*

**Key themes:** Cognitive enhancement, smart drugs, power/privilege/access, informed consent, inequality

**Connects to:** [Smart Drugs and Cognitive Enhancement](https://spoileralert.wtf/md-files/est_smart_drugs.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Limitless film page](https://spoileralert.wtf/md-files/movies_limitless.md)
...
**2013 · Neill Blomkamp**
*Status: In the book — Chapter 6*

**Key themes:** Bioprinting, automation, inequality, corporate responsibility, power/privilege/access, too valuable to fail

**Connects to:** [Bioprinting](https://spoileralert.wtf/md-files/est_bioprinting.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Elysium film page](https://spoileralert.wtf/md-files/movies_elysium.md)
...
**1995 · Mamoru Oshii**
*Status: In the book — Chapter 7*

**Key themes:** Human augmentation, brain-computer interfaces, identity, surveillance, what makes us human, informed consent

**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Ghost in the Shell film page](https://spoileralert.wtf/md-files/movies_ghost_in_the_shell.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Superintelligence](https://spoileralert.wtf/md-files/est_superintelligence.md) · [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Ex Machina film page](https://spoileralert.wtf/md-files/movies_ex_machina.md)
...
**Connects to:** [Technological Convergence](https://spoileralert.wtf/md-files/est_technological_convergence.md) · [Mind Uploading](https://spoileralert.wtf/md-files/est_mind_uploading.md) · [Superintelligence](https://spoileralert.wtf/md-files/est_superintelligence.md) · [Hype vs. Reality](https://spoileralert.wtf/md-files/ntf_hype_vs_reality.md) · [Transcendence film page](https://spoileralert.wtf/md-files/movies_transcendence.md)
...
**Connects to:** [Nanotechnology](https://spoileralert.wtf/md-files/est_nanotechnology.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [The Man in the White Suit film page](https://spoileralert.wtf/md-files/movies_man_in_the_white_suit.md)
...
**2016 · Ron Howard**
*Status: In the book — Chapter 11*

**Key themes:** Gain-of-function research, synthetic biology, dual-use research, biosecurity, could we/should we

**Connects to:** [Gain-of-Function Research](https://spoileralert.wtf/md-files/est_gain_of_function.md) · [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Inferno film page](https://spoileralert.wtf/md-files/movies_inferno.md)
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Geoengineering](https://spoileralert.wtf/md-files/est_geoengineering.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [The Day After Tomorrow film page](https://spoileralert.wtf/md-files/movies_day_after_tomorrow.md)
...
**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) · [Hype vs. Reality](https://spoileralert.wtf/md-files/ntf_hype_vs_reality.md) · [Religion, Belief, and Technology](https://spoileralert.wtf/md-files/rei_religion_belief_technology.md) · [Contact film page](https://spoileralert.wtf/md-files/movies_contact.md)
...
**2005 · Garth Jennings (and the 1981 BBC series)**
*Status: Bookend — frames Chapter 14*

**Key themes:** Don't panic, hype vs. reality, resilience, the human dimension

**Connects to:** [Don't Panic](https://spoileralert.wtf/md-files/ntf_dont_panic.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Chapter 14: Looking to the Future](https://spoileralert.wtf/md-files/ch14_looking_to_the_future.md)
...
**1927 · Fritz Lang**
*Status: Considered — not included*

**Key themes:** Automation, robotics, inequality, corporate power, role of scientists

**Connects to:** [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**Connects to:** [Nanotechnology](https://spoileralert.wtf/md-files/est_nanotechnology.md) · [Bioprinting](https://spoileralert.wtf/md-files/est_bioprinting.md)
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**Connects to:** [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md)

**Notes:** From 2018: "No — too slow." From 2026: on a revisit not as slow as I remembered (I'm getting older!) Claude: Notable for its trio of robots Huey, Dewey, and Louie — Andrew gave them a shout-out in his [Substack piece on AI films that make you cry](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3) — but the film itself didn't make the cut.
...
**Connects to:** [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)
...
**Connects to:** [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Religion, Belief, and Technology](https://spoileralert.wtf/md-files/rei_religion_belief_technology.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Superintelligence](https://spoileralert.wtf/md-files/est_superintelligence.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md)
...
**1985/1989/1990 · Robert Zemeckis**
*Status: Added since publication*

**Key themes:** Time, cause and effect, complexity and unintended consequences, the limits of prediction, family systems, small actions and large outcomes, the "what if" structure of sci-fi

**Connects to:** [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Hype vs. Reality](https://spoileralert.wtf/md-files/ntf_hype_vs_reality.md) · [Why Sci-Fi Movies Matter](https://spoileralert.wtf/md-files/ntf_why_scifi_movies_matter.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md) · [Risk Innovation](https://spoileralert.wtf/md-files/ntf_risk_innovation.md)

**Notes:** From 2026: I can't believe I missed the Back to the Future Films in my initial shortlist for the book! A bit of a blind spit, but it may be that when i last watched the original it didn't resonate as much as it did first time round. That said, there are themes across the three films that probably resonate more now than they did back in 2018 — drfinitely worth a revisit with a futures-critical eye!

And, Claude decided to also weigh in here: Claude: It is also a film that almost uniquely rewards repeat viewing from a book-of-ideas angle. The causal structure is so tight that every scene becomes a small lesson in how systems respond to perturbation. And the film itself has become part of the cultural conversation about technology in ways that make it more, not less, thematically relevant — "we have the hoverboards, just not the way we were promised" is now a standard rhetorical move in hype-vs-reality conversations.
...
**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**Connects to:** [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Technological Convergence](https://spoileralert.wtf/md-files/est_technological_convergence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Key themes:** Biosecurity, containment, paranoia, the role of scientists, dual-use research, epistemic uncertainty, trust and verification

**Connects to:** [Gain-of-Function Research](https://spoileralert.wtf/md-files/est_gain_of_function.md) · [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Dual-Use Research and Biosecurity](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [The Role of Scientists and Innovators](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Pandemic Preparedness and Biosurveillance](https://spoileralert.wtf/md-files/p18_pandemic_preparedness.md) · [Inferno (chapter)](https://spoileralert.wtf/md-files/ch11_inferno.md)

**Notes:** From 2026: Carpenter's *The Thing* is a film that I really like, and looking back I'm not sure why it didn't make the initial shortlist — although this may be because I was struggling to find enough nuance in it. Well worth exploring further through the themes of the book though — and emerging conversations around advanced technologies and the future, and how we handle them. 

And a word from Claude: Worth pairing with Carpenter's technical restraint — practical effects, long silences, a cold that you can feel from the screen — against the more polished recent pandemic films like *Contagion*. The paranoia is doing something different from the information cascade in *Contagion*; it is showing what happens when the epistemic tools themselves fail. That is a framework the book's "what we know and how we know it" threads (through *Contact*) were designed for.
...
**Key themes:** Cyberpunk, biotech, government experimentation, surveillance, power dynamics, human augmentation, post-disaster urban futures, body horror, technological hubris

**Connects to:** [Human Augmentation and Body Modification](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Informed Consent and Autonomy](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Ghost in the Shell (chapter)](https://spoileralert.wtf/md-files/ch07_ghost_in_the_shell.md)

**Notes:** From 2026: I didn't watch Akira until after I'd written Films from the Future, which explains its absence on the shortlist of movies. It was actually introduced to me by students in my Moviegoer's Guide to the Future class, and we watched it one year as the bonus movie. It is, it has to be said, a complex anime movie that requires a lot of attention to follow and make sense of. It's also highly polarizing in terms of fans who love it, and viewers who find it tedious and inpenetrable. But a lot to chew over in the movie when thinking about tech, society, and the future - and a classic sci fi anime movie to boot.

From Claude: *Akira* is the one the cyberpunk tradition measures itself against. Otomo's 1988 anime — adapted from his own manga — takes place in Neo-Tokyo thirty-one years after the city was destroyed in a catastrophic blast. The government has been conducting secret experiments on children with latent psychic ability. One of them, Tetsuo, acquires powers he cannot control, and the film becomes a meditation on what happens when biotechnology and power are placed in hands that were never meant to hold them — and on who gets to decide which children are expendable. The thematic payload runs directly into *Ghost in the Shell*'s territory (which is in the book) and into the *Never Let Me Go* wrong-question frame (instrumentalised subjects whose humanity is quietly negotiated away). It also happens to be one of the most formally ambitious films in animation history, with a visual lexicon that defined a generation of what sci-fi could look like. The overlap with the book's frameworks is not subtle; the omission is easier to explain as scope than as oversight.
...
**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**Connects to:** [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Predictive Algorithms](https://spoileralert.wtf/md-files/est_predictive_algorithms.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md)
...
**1999 · Brad Bird**
*Status: Considered — added to watchlist*

**Key themes:** AI, robotics, human dignity, empathy, militarism and technology, fear of the unknown

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Everyone Has a Role to Play](https://spoileralert.wtf/md-files/ntf_everyone_has_a_role.md)

**Notes:** From 2026: Featured in my [Substack piece on AI films that make you cry](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3), where I describes it as "a touching story of a young boy who befriends a mysterious robot while trying to protect it from an over-zealous military bent on its destruction." Claude: Mature themes around compassion, empathy, and closed-mindedness that resonate as much today as when it was released.
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)

**Notes:** From 2026: From my [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3): "For all its flaws (and there are more than a few), I have a soft spot for it." "It definitely has its teary moments!" Claude: A robot's journey from mechanical slave to full personhood — exploring slavery, prejudice, freedom, love, immortality, and what it means to be human. 
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)

**Notes:** From 2018: "This is a solid one — lots of themes to explore." Andrew's number one pick in his [piece on AI films that make you cry](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3): "Over the years it's become one of my go-to movies that centers on how a smart, empathetic robot holds a mirror up to our own humanity." From 2026: Appreciate this more with every watching. Very sadly too long to show in class. Claude: A film that took time to grow on him, but became deeply important.
...
**Connects to:** [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)
...
**1951/2008 · Robert Wise / Scott Derrickson**
*Status: Considered — not included*

**Key themes:** Extraterrestrial life, intergenerational responsibility, climate science, could we/should we

**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md)
...
**Connects to:** [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md)
...
**2009 · McG**
*Status: Considered — added since*

**Key themes:** AI, robotics, automation, human dignity, identity, what makes us human

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Gain-of-Function Research](https://spoileralert.wtf/md-files/est_gain_of_function.md) · [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md)
...
**Connects to:** [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md)

**Notes:** From 2018: "Too slow." From 2026: Feel as if I should like the film, but still struggle with it. Just a little preachy. Claude: A surprising verdict on one of Pixar's most beloved films. Andrew mentioned it as a near-miss in his [Substack piece on AI films that make you cry](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3), but it didn't survive the pacing test for the book.
...
**Connects to:** [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md)
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Geoengineering](https://spoileralert.wtf/md-files/est_geoengineering.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Everyone Has a Role to Play](https://spoileralert.wtf/md-files/ntf_everyone_has_a_role.md)
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)

**Notes:** From 2018: "On the fence here — watch again." From 2026: Grows on me over time and the themes are good - too much adulation from the ohysics community though. Overshadows other themes. Claude: Andrew also gave a shout-out to the AIs TARS and CASE in his [Substack piece on AI films](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3). A film about what we owe future generations — and what we're willing to lie about to save them.
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Gain-of-Function Research](https://spoileralert.wtf/md-files/est_gain_of_function.md) · [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md)
...
**Connects to:** [Smart Drugs and Cognitive Enhancement](https://spoileralert.wtf/md-files/est_smart_drugs.md) · [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md)
...
**Connects to:** [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md)
...
**Connects to:** [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md)
...
**Connects to:** [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Too Valuable to Fail](https://spoileralert.wtf/md-files/rei_too_valuable_to_fail.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)

**Notes:** From 2018: "I like the themes here — think about." From 2026: Really like - still a strong contender, and one of the films that got me thinking about writing the book. Claude: Also featured in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3) as "on the lighter side of bringing a tear to the eye" — a gentle film about a former jewel thief with dementia and his carer robot. "A gentle and poignant movie."
...
**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md)
...
**Connects to:** [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Smart Drugs and Cognitive Enhancement](https://spoileralert.wtf/md-files/est_smart_drugs.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)
...
**Connects to:** [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md)
...
**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**Connects to:** [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Technological Convergence](https://spoileralert.wtf/md-files/est_technological_convergence.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Mind Uploading](https://spoileralert.wtf/md-files/est_mind_uploading.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)

**Notes:** From 2026: A film that makes you think. Worth watching and exploring, especially give themes around AI, relationships and attachment. Claude: Mentioned in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3) as a near-miss for his AI tearjerker list. A scientist working on a human-equivalent AI in a remote facility — echoes of Ex Machina's isolation, with different emotional stakes.
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Hype vs. Reality](https://spoileralert.wtf/md-files/ntf_hype_vs_reality.md)
...
**2021 · Miguel Sapochnik**
*Status: Added since publication*

**Key themes:** AI, robotics, human dignity, intergenerational responsibility, resilience, the human dimension

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)

**Notes:** From 2026: Ok, but a little slow and one note. Claude: Mentioned in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3) as a near-miss. A dying man builds a robot to care for his dog after he's gone — the most intimate possible version of the question: what do we build, and for whom?
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md) · [Mind Uploading](https://spoileralert.wtf/md-files/est_mind_uploading.md) · [Digital Resurrection, Grief Tech, and AI Companions of the Dead](https://spoileralert.wtf/md-files/p18_grief_tech.md)

**Notes:** From 2026: A really nuanced film about AI, relationships, and attachment - especially with kids. Worth watching and discussing, although you do have to invest in it. Claude: From Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3): "A moving and surprising retrospective on the life of an android designed to play the role of an artificial sibling to a young adopted girl." He made the mistake of first watching it on a long flight — "to my embarrassment, I ended up in my seat with tears running down my face!"

---

### Swan Song

**2021 · Benjamin Cleary**
*Status: Added since publication*

**Key themes:** Cloning, identity, informed consent, human dignity, deception/manipulation, what makes us human

**Connects to:** [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)
...
**2023 · Gerard Johnstone**
*Status: Added since publication*

**Key themes:** AI, robotics, corporate responsibility, autonomy, could we/should we, permissionless innovation

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md)
...
**2025 · Gerard Johnstone**
*Status: Added since publication*

**Key themes:** AI, robotics, autonomy, corporate responsibility, consciousness, too valuable to fail

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Too Valuable to Fail](https://spoileralert.wtf/md-files/rei_too_valuable_to_fail.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md)
...
**Connects to:** [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md)
...
**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md)
...
**Notes:** From 2026: Another good AI/robot movie with a different take on artificial intelligence. Good conversation starter. Claude: Mentioned in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3) as a near-miss. A police robot that gains consciousness and has to learn what it means to be alive — from the director of Elysium.
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md)

**Notes:** From 2026: Really like this movie as a surprisingly enjoable yet not simplistic way of exploring ideas around AI. Love the positive AI vibe. A favorite. Claude: Mentioned in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3). An inflatable healthcare robot and a grieving teenager. One of the most accessible entry points for younger audiences into questions about AI, care, and what technology is for.

---

### Ron's Gone Wrong

**2021 · Sarah Smith & Jean-Philippe Vine**
*Status: Suggested*

**Key themes:** AI, robotics, corporate responsibility, surveillance, the human dimension

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md)

**Notes:** From 2026: Seriously underrated film - complex themes around AI and humans. Well worth watching. Claude: Mentioned in Andrew's [Substack piece](https://www.futureofbeinghuman.com/p/five-robot-movies-that-will-make-you-cry-47848fb79ef3). Every kid has a personal robot companion — except the one whose robot is glitchy. A children's film with surprisingly sharp commentary on tech companies and data harvesting.
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md)
...
**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)
...
**Connects to:** [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md)
...
**1982/2010 · Steven Lisberger / Joseph Kosinski**
*Status: Added to watchlist*

**Key themes:** AI, identity, corporate responsibility, autonomy, simulation, consciousness

**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**1990/2012 · Paul Verhoeven / Len Wiseman**
*Status: Added to watchlist*
...
**Connects to:** [Brain-Computer Interfaces](https://spoileralert.wtf/md-files/est_brain_computer_interfaces.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md)
...
**2011 · Gonzalo López-Gallego**
*Status: Added to watchlist*

**Key themes:** Extraterrestrial life, dual-use research, deception/manipulation, the role of scientists

**Connects to:** [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Dual-Use Research](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Deception and Manipulation](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md)
...
**Connects to:** [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)
...
**Key themes:** Orbital infrastructure, Kessler syndrome, complexity and cascading failure, risk innovation, the fragility of space systems, the lived experience of technological collapse

**Connects to:** [Space Industrialization and Orbital Infrastructure](https://spoileralert.wtf/md-files/p18_orbital_infrastructure.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Risk Innovation](https://spoileralert.wtf/md-files/ntf_risk_innovation.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md)

**Notes:** From 2026: I remember being in two minds about Gravity when compiling the shortlist for the book. I enjoyed it - I'm a Cuarón fan - but it is quite one-note and lacks nuance at a level where it opens up multiple conversations. There also wasn't much room in the book for a near Earth orbit film like this. That said, with low earth orbit becoming increasingly crowded, it's probably a film to come back to!

Claude would like to add: Gravity has aged into a film that is no longer only about one astronaut's survival after an orbital accident — it is now, more urgently, the clearest cinematic articulation of what a Kessler-syndrome cascade looks like at human scale. The film's inciting incident is a destructive Russian anti-satellite weapons test whose debris field sets off a chain of collisions that sweeps through the altitude bands other spacecraft occupy. In 2013 this was a premise. In 2025 it is a policy conversation in the ITU and the FCC, with more than eleven thousand active satellites in orbit and Starlink alone nearing ten thousand. The film's technical consultants got it substantially right; it is the film's willingness to sit with what happens after the cascade starts that makes it indispensable alongside the new [orbital infrastructure page](https://spoileralert.wtf/md-files/p18_orbital_infrastructure.md). Also: Cuarón's long-take sequences do something for the felt experience of the orbital environment that policy documents never will. If the Kessler conversation is going to stay coherent for a general audience, it will be partly because this film exists. [Andrew - I have to agree with this!]
...
**Key themes:** Space industrialisation, corporate space infrastructure, one-way missions, the human cost of institutional ambition, the colonial-legacy angle in off-world settlement, father-son dynamics as mission logic

**Connects to:** [Space Industrialization and Orbital Infrastructure](https://spoileralert.wtf/md-files/p18_orbital_infrastructure.md) · [Mars Settlement and the New Frontier Mythology](https://spoileralert.wtf/md-files/p18_mars_settlement.md) · [The Search for Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)

**Notes:** From 2026: I must admit I was disappointed with *Ad Astra* and found it to be rather self-important and self-obsessed. But this, if course, does not make it any less worth while. And it is a good film for provoking thought and conversation. 

Claude added: Gray's *Ad Astra* is the anti-*Martian* in important respects — a film about space that is mostly about what space does to people, institutions, and the families and political economies that send them. Brad Pitt's astronaut transits a near-future solar system full of commercial lunar surface installations, private launch operations, tourist infrastructure on the Moon, contested resource-extraction fields on Mars, and a classified deep-space programme that has cost more than the public has been told. Every new frame reminds you that this is a future someone is building on deliberate choices that are being made right now. The colonial-legacy framing — what communities are displaced, what labour is invisible, whose mission this actually is — is the angle the book's frameworks most urgently want from the space conversation, and *Ad Astra* carries it better than any other mainstream space film I know. Pairs especially well with both the new [orbital infrastructure](https://spoileralert.wtf/md-files/p18_orbital_infrastructure.md) and [Mars settlement](https://spoileralert.wtf/md-files/p18_mars_settlement.md) pages. The quieter counterpoint to *Gravity*'s visceral catastrophe: the slow erosion of what space is for when the institutions that built it start working in their own interest rather than anyone else's.
...
**Connects to:** [Climate Science](https://spoileralert.wtf/md-files/est_climate_science.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md)
...
**Connects to:** [Surveillance](https://spoileralert.wtf/md-files/est_surveillance.md) · [Surveillance, Privacy, and Control](https://spoileralert.wtf/md-files/rei_surveillance_privacy_control.md) · [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Power, Privilege, and Access](https://spoileralert.wtf/md-files/rei_power_privilege_access.md)
...
**Connects to:** [Cloning](https://spoileralert.wtf/md-files/est_cloning.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Automation](https://spoileralert.wtf/md-files/est_automation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md)
...
**Connects to:** [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md)
...
**2011–2024 · Rupert Wyatt / Matt Reeves / Wes Ball**
*Status: Added to watchlist*
...
**Connects to:** [Genetic Engineering](https://spoileralert.wtf/md-files/est_genetic_engineering.md) · [Gain-of-Function Research](https://spoileralert.wtf/md-files/est_gain_of_function.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md)
...
**Connects to:** [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [The Human Dimension](https://spoileralert.wtf/md-files/ntf_human_dimension.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md)
...
**Connects to:** [Human Augmentation](https://spoileralert.wtf/md-files/est_human_augmentation.md) · [Could We? Should We?](https://spoileralert.wtf/md-files/rei_could_we_should_we.md) · [The Role of Scientists](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Human Dignity](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md)
...
**2026 · Phil Lord and Christopher Miller**
*Status: Added since publication*

**Key themes:** First contact, microbial biology, extinction-level climate crisis, problem-solving under constraint, collaboration across species, space travel, technological convergence, the limits of human cognition

**Connects to:** [The Search for Extraterrestrial Life](https://spoileralert.wtf/md-files/est_extraterrestrial_life.md) · [Climate Science and Complex Earth Systems](https://spoileralert.wtf/md-files/est_climate_science.md) · [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md) · [Space Industrialization and Orbital Infrastructure](https://spoileralert.wtf/md-files/p18_orbital_infrastructure.md) · [Mars Settlement and the New Frontier Mythology](https://spoileralert.wtf/md-files/p18_mars_settlement.md) · [Technological Convergence](https://spoileralert.wtf/md-files/ntf_technological_convergence.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Contact (chapter)](https://spoileralert.wtf/md-files/ch13_contact.md)

**Notes:** From 2026: This is a tough one. I superficially enjoyed Project Hail Mary — its a good, light entertaining romp. But there are aspects of it that deeply trouble me. One is that despite claims of scientific accuracy I found the film to be shallow on this front - speaking as a scientist. More importantly, there is throwaway morality here around the good of the many being more important than the good of the few that is deeply, deeply disturbing. Even moreso as the film normalizes this without the audience realizing. The philosophy behind it clashes deeply with my own - but maybe that's what makes it a good discussion starter.

And Claude wanted to add: Phil Lord and Christopher Miller's adaptation of Andy Weir's 2021 novel, with Ryan Gosling in the lead and Drew Goddard adapting. Released in the US on March 20, 2026 and, against expectations for a dense scientific problem-solving story, it has landed both critically (94% on Rotten Tomatoes) and commercially ($515M gross). The premise in one line: a lone astronaut sent on a suicide mission to investigate a microbial organism — *astrophage* — that is eating the Sun's energy and threatening Earth with rapid cooling; along the way, first contact with an alien scientist on a parallel mission from a parallel crisis. What makes this book-relevant in a way *The Martian* is not, exactly: *The Martian* is a film about technical optimism under bounded constraint. *Project Hail Mary* is a film about what collaboration looks like when the problem is genuinely intractable, the life-forms involved are strange in ways the problem-solvers cannot immediately parse, and the climate-scale stakes are built into the premise rather than appended to it. The "science" in the film — astrophage, xenonite, the pressure differentials that shape first-contact engineering — works exactly the way the book argues sci-fi should: as a thinking-tool for real problems, not a prediction. The film sits unusually well alongside the site's newer pages on space infrastructure and Mars settlement — not because it endorses their framings, but because it offers a third option: a story in which leaving Earth is a matter of averting extinction rather than escaping it, and where the measure of a mission's success is not whether settlement is achieved but whether the home world is saved. Worth pairing with the [*Contact*](https://spoileralert.wtf/md-files/movies_contact.md) chapter for the scientific-method angle, and with the [Mars settlement page](https://spoileralert.wtf/md-files/p18_mars_settlement.md) for the planet-B-vs-planet-repair counterpoint. [Andrew - as you can see, Claude and i disagree on this one!]
...
**Key themes:** What makes us human, cognitive sentience, moral status, synthetic biology, intergenerational responsibility, the role of scientists

**Connects to:** [What do we owe a lump of brain tissue in a dish?](https://spoileralert.wtf/md-files/ceq_moral_status_neural_tissue.md) · [Human Dignity and What Makes Us Human](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [The Role of Scientists and Innovators](https://spoileralert.wtf/md-files/rei_role_of_scientists.md) · [Intergenerational Responsibility](https://spoileralert.wtf/md-files/rei_intergenerational_responsibility.md) · [Synthetic Biology](https://spoileralert.wtf/md-files/est_synthetic_biology.md)

**Notes:** From 2026: It was a student that introduced me to this film as I was teaching the Moviegoer's Guide to the Future course at ASU, which is based on the book Films from the Future. I was absolutely captivated by the story telling and the twist. This would probably make the cut for a sequel to the book given the way it explores complex issues - especially around what it means to be human. During COVID I was working on a parallel course on infectious disease-based movies with a friend that we never ended up teaching. This movie was on the list. It also opens up the whole field of fungi and human impacts which to this day remains underexplored. Claude: Takes Never Let Me Go's "what do we owe engineered beings?" question and pushes it one step further — what if the engineered being is also the species' successor? Shares thematic DNA with Splice and belongs alongside the brain-organoid moral-status discussion.
...
**Key themes:** Pandemic preparedness, global response, resilience, complexity, biosecurity

**Connects to:** [Pandemic Preparedness and Biosurveillance](https://spoileralert.wtf/md-files/p18_pandemic_preparedness.md) · [Resilience and Adaptation](https://spoileralert.wtf/md-files/ntf_resilience_adaptation.md) · [These technologies don't stop at borders. How do we govern them?](https://spoileralert.wtf/md-files/ceq_governing_across_borders.md) · [Complexity, Chaos, and Unintended Consequences](https://spoileralert.wtf/md-files/ntf_complexity_chaos.md) · [Dual-Use Research and Biosecurity](https://spoileralert.wtf/md-files/rei_dual_use_biosecurity.md)

**Notes:** From 2026: A highly enjoyable film and one that I come back to a lot. Slightly thin in nuanced themes that would have made it good for the book, but nevertheless a great high-octane conversation starter. Claude: A Hollywood-scale take on Inferno territory — the response spans institutions, governments, and an invented "camouflage" solution that resolves the crisis through adaptation rather than cure. A useful pairing with the Post-2018 pandemic preparedness page for classes on cross-border coordination.
...
**Key themes:** What makes us human, AI, deception/manipulation, permissionless innovation, conformity

**Connects to:** [Human Dignity and What Makes Us Human](https://spoileralert.wtf/md-files/rei_human_dignity.md) · [Deception, Manipulation, and Convenient Lies](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) · [Permissionless Innovation and Technological Hubris](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) · [How do I know what's real anymore?](https://spoileralert.wtf/md-files/ceq_whats_real.md) · [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md)

**Notes:** From 2026: This was an embarrassing omission - a great film by a great director with a great cast, and a classic. Lots of subtle themes cleverly explored - worth watching for pure entertainment and as a thought provoking conversation starter. Plus, Simon Pegg! Claude: Wright's third Cornetto Trilogy entry hides a serious question under a pub crawl — are the mess, friction, and self-destruction that define us worth keeping when a benevolent intelligence offers a tidier version? Approaches Ex Machina's alignment questions through an unexpected door.

---

## How about all those missing movies?!
...
This is not how we’ll be watching movies in this class. But don’t worry — most of the movies we’ll be watching together are even better when you’re concentrating on what they’re saying, and what
...
**Pay attention.** Every aspect of a movie — from the music, to the atmosphere, to the subtle expressions and body language of actors — can convey information, and spark new ideas. Pay
attention to everything!

**Focus. **Before each movie, you should have identified three ideas or topics in your pre-reflection. Actively look for anything in the movie that is relevant to these, and that stimulates interesting and new
insights into them.

**Be inspired.** Embrace the serendipity of new and novel ideas and insights that you weren’t expecting.

**Make connections.** Look for common threads between diﬀerent movies. These might be similar ideas, or diﬀerent perspectives on the same idea. But they could also be as simple as the same actor, or producer, or composer, being associated with diﬀerent movies, or similar settings or locations, or narrative arcs. Be imaginative in the connections you make!
