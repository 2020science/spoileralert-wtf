## "Should anyone have the right to alter the Earth's atmosphere on purpose?"
...
[The Day After Tomorrow](/md-files/movies_day_after_tomorrow.md) is the book's entry point for thinking about climate as a complex system — a system where small perturbations can trigger cascading, irreversible changes. The film gets the science wrong in its specifics (the timeline is absurdly compressed), but the underlying insight — that climate is not a thermostat you can adjust — is profoundly right.

[Intergenerational Responsibility](/md-files/rei_intergenerational_responsibility.md) is the ethical heart of this question. Geoengineering does not just affect the people who decide to implement it. It affects every generation that comes after. The termination problem means we would be binding our grandchildren to a maintenance program for the atmosphere, with no way for them to opt out safely. See [What do we owe people who haven't been born yet?](/md-files/ceq_intergenerational_obligation.md)

[Could We? Should We?](/md-files/rei_could_we_should_we.md) at planetary scale. The technology to alter the atmosphere is becoming available. The question is not whether someone will try — that is already happening (see [Active Geoengineering Proposals](/md-files/p18_active_geoengineering.md)). The question is whether it will be done with coordination, governance, and accountability, or unilaterally by whoever has the resources and the will.

### Explore Further

- [Active Geoengineering Proposals](/md-files/p18_active_geoengineering.md) — what is already being attempted
- [Carbon Removal and Climate Tech](/md-files/p18_carbon_removal.md) — the complementary approach
- [Climate Science and Complex Earth Systems](/md-files/est_climate_science.md) — understanding the system being altered
- [Intergenerational Responsibility](/md-files/rei_intergenerational_responsibility.md) — obligations to future generations
- [Complexity and Unintended Consequences](/md-files/ntf_complexity_chaos.md) — why intervention in complex systems is risky
- [What do we owe people who haven't been born yet?](/md-files/ceq_intergenerational_obligation.md) — the deeper ethical question
