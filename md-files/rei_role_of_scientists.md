...
- Should scientists be advocates for the social implications of their work, or does advocacy compromise their objectivity?
- Is good intention sufficient when the consequences of innovation extend far beyond what the innovator anticipated?
- What happens when brilliant people do not think about the social impact of their work until it is too late?
...
- [Innovating responsibly in a culture of entrepreneurship](https://www.futureofbeinghuman.com/p/responsible-innovation) — Andrew Maynard examines the pressures that entrepreneurial culture places on scientists and innovators, and how those pressures can crowd out reflection on social consequences, arguing for integrating responsibility into the DNA of innovation rather than treating it as an afterthought.
- [Contact — Moviegoer's Guide to the Future (Episode 13)](https://www.futureofbeinghuman.com/p/living-by-more-than-science-alone) — Maynard explores how Contact models a more engaged form of scientific practice, where Ellie Arroway navigates the intersection of evidence-based inquiry and broader human values, examining what it means for scientists to be honest brokers in a world where their discoveries carry profound social implications.
- [The Honest Broker: Making Sense of Science in Policy and Politics — Roger Pielke Jr.](https://doi.org/10.1017/CBO9780511818110) — Pielke's influential framework distinguishes between four roles scientists can play in public life — pure scientist, science arbiter, issue advocate, and honest broker — providing essential vocabulary for the debates about scientific responsibility that Films from the Future raises.
- [Responsible Innovation for Disruptive Science and Technology: The Role of Public Trust — Keast, Burton, et al., Technological Forecasting and Social Change (2024)](https://www.sciencedirect.com/science/article/pii/S0160791X24002574) — Drawing on a survey of over 4,000 Australians, this study finds that of all elements of responsible innovation, the individual practices of scientists matter most for public trust in the research sector — reinforcing the book's argument that what scientists do and how they engage with society is central to their work's legitimacy.
- [An Agenda for Science Communication Research and Practice — Scheufele et al., PNAS (2025)](https://www.pnas.org/doi/10.1073/pnas.2400932122) — This agenda-setting article argues that the public sphere for science has fragmented into Substacks, podcasts, and social media, challenging the common expert tendency to "defend" science from audiences and insisting that dialogue, not defense, is the scientist's proper posture — as scientific evidence and societal values jointly shape public policy.
- [Ethics in Science Communication and Engagement — Wilkinson et al., Science Communication (2025)](https://journals.sagepub.com/doi/10.1177/10755470251334305) — This peer-reviewed study finds that ethical questions in science communication often fall into gaps between what institutions classify as "research" versus "dissemination," leaving scientists to navigate engagement dilemmas largely on their own — with the post-COVID landscape sharpening attention to equity, social justice, and whose voices count.
- [What Does Research Say About How to Effectively Communicate About Science? — Andrew Maynard and Dietram Scheufele, *The Conversation* (2016)](https://theconversation.com/what-does-research-say-about-how-to-effectively-communicate-about-science-70244) — Writing as members of the National Academies committee behind *Communicating Science Effectively*, Maynard and Scheufele argue that the traditional deficit model — simply giving people more information — does not work, and that scientists must adopt evidence-based, systems-level approaches to communication that account for how people actually process and act on scientific information.
