...
Each of these now has a dedicated page in the [Post-2018 Developments](/md-files/domain_post_2018_developments.md) domain, with connections to the book's frameworks and to related [Complex Emerging Questions](/md-files/domain_complex_emerging_questions.md):

- **Large language models** — See [p18_llms_frontier_ai.md](/md-files/p18_llms_frontier_ai.md). The book's Plato's Cave framework (Ex Machina) and the distinction between the imaginable and the plausible directly address the manipulation risks, hype cycles, and governance gaps surrounding LLMs.
- **The CRISPR babies case (He Jiankui, 2018)** — See [p18_crispr_babies_embryo_selection.md](/md-files/p18_crispr_babies_embryo_selection.md). Announced the same month the book was published. The "could we / should we" framework, the role-of-scientists analysis, and the "immoral logic" pattern from Inferno were already built for exactly this scenario.
- **Deepfakes and synthetic media** — See [p18_deepfakes_synthetic_media.md](/md-files/p18_deepfakes_synthetic_media.md). The deception and manipulation framework provides a direct lens for understanding how synthetic media erodes trust in evidence itself.
- **COVID-19 and the gain-of-function debate** — See [p18_pandemic_preparedness.md](/md-files/p18_pandemic_preparedness.md). The Inferno chapter's treatment of dual-use research and the biosecurity analysis proved prescient.
- **Neuralink and commercial brain-computer interfaces** — See [p18_commercial_bcis.md](/md-files/p18_commercial_bcis.md). Ghost in the Shell's analysis of corporate ownership of the augmented body and the identity questions raised by technology inside the mind transfer directly.
- **AI-generated art and creative AI** — See [p18_ai_generated_art.md](/md-files/p18_ai_generated_art.md). The role-of-art-and-culture framework, combined with the automation and power/privilege analyses, addresses both the creative and economic dimensions.
- **Autonomous vehicles** — See [p18_autonomous_vehicles.md](/md-files/p18_autonomous_vehicles.md). Questions around power, decision making, governance, responsibility for failures, and risk/benefit tradeoffs. Relevant to Waymo, Zoox, Tesla, and autonomous trucks, trains, and airborne vehicles.
- **Autonomous weapons** — See [p18_autonomous_weapons.md](/md-files/p18_autonomous_weapons.md). The automation framework (Elysium's robotic police), the algorithmic bias analysis (Minority Report), and the informed consent framework combine to address lethal autonomous systems.
