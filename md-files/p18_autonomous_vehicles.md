...
**Labor displacement** is not hypothetical. Long-haul trucking, taxi driving, and ride-hailing employ millions of people globally. The book's discussion of automation and the "disposable workforce" in [Elysium](https://spoileralert.wtf/md-files/movies_elysium.md) anticipated exactly this kind of transition — and the social question of what happens to people whose livelihoods depend on driving is as important as the technology itself.

And the **permissionless innovation** dimension is stark. Companies like Tesla have effectively used their customers as beta testers for autonomous driving technology on public roads — a decision that the book's framework for [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) would scrutinize closely.

### Explore Further

- [Artificial Intelligence](https://spoileralert.wtf/md-files/est_artificial_intelligence.md) — the core technology enabling autonomous driving
- [Automation and Robotics](https://spoileralert.wtf/md-files/est_automation.md) — the broader automation and labor context
- [Hype vs. Reality](https://spoileralert.wtf/md-files/ntf_hype_vs_reality.md) — counting the assumptions in autonomous vehicle timelines
- [Permissionless Innovation](https://spoileralert.wtf/md-files/rei_permissionless_innovation.md) — when companies deploy first and ask permission later
- [Corporate Responsibility](https://spoileralert.wtf/md-files/rei_corporate_responsibility.md) — the profit motive in safety-critical systems
- [Is technological progress actually making most people's lives better?](https://spoileralert.wtf/md-files/ceq_progress_for_whom.md) — who benefits, who loses
