...
### The Power Dynamics of Watching
...
- How much privacy should we be willing to surrender for the promise of safety, and who gets to set that tradeoff?
- Can predictive algorithms ever be truly fair, given that they are trained on data from unfair systems?
- What does meaningful consent look like when data collection is invisible and pervasive?
- As our bodies become networked, who owns the data they generate, and who has the right to access it?
- How do we build accountability into systems that operate at a speed and scale beyond human oversight?
...
- [Minority Report — Moviegoer's Guide to the Future (Episode 4)](https://www.futureofbeinghuman.com/p/minority-report-predicting-criminal) — Andrew Maynard explores how Minority Report anticipates the rise of predictive policing and algorithmic justice, examining the tension between public safety and individual rights and connecting the film's Precrime system to real-world tools that claim to predict criminal behavior.
- [Can watching sci-fi movies lead to more responsible and ethical innovation?](https://www.futureofbeinghuman.com/p/can-watching-sci-fi-movies-lead-to-more-responsible-and-ethical-innovation-7c993bdaa5c2) — Maynard makes the case that engaging with films like Minority Report and Ghost in the Shell can sharpen our thinking about the ethical implications of surveillance technologies, arguing that science fiction provides a valuable space for rehearsing difficult conversations about privacy, control, and accountability.
- [Algorithms of Oppression — Safiya Umoja Noble (NYU Press)](https://nyupress.org/9781479837243/algorithms-of-oppression/) — Noble's groundbreaking research demonstrates how search engines and algorithmic systems reinforce racial and gender biases, providing essential context for understanding how surveillance and predictive technologies can systematically disadvantage marginalized communities.
- [The EU Artificial Intelligence Act](https://artificialintelligenceact.eu/) — The European Union's landmark AI regulation, which entered into force in 2024, establishes the world's first comprehensive legal framework for governing AI systems including those used in law enforcement, biometric surveillance, and predictive policing — setting precedents for how democracies can regulate algorithmic surveillance.
- [Facial Recognition and Biometric Technologies — Electronic Frontier Foundation](https://www.eff.org/issues/face-recognition) — The EFF's ongoing work documents how facial recognition and biometric surveillance technologies are being deployed, the civil liberties concerns they raise, and the legal and technical challenges of protecting privacy in an age of pervasive digital monitoring.
- [Algorithmic Fairness in Predictive Policing — AI and Ethics (2024)](https://link.springer.com/article/10.1007/s43681-024-00541-3) — This peer-reviewed systematic review examines fairness strategies in predictive policing systems, finding that police actions themselves are a major contributor to model discrimination and that current approaches to bias mitigation leave significant gaps across age, gender, and socioeconomic dimensions.
- [What Experts Can Learn by Tracking AI Harms — Bulletin of the Atomic Scientists (2026)](https://thebulletin.org/2026/01/what-experts-can-learn-by-tracking-ai-harms/) — Drawing on the AI Incident Database's catalogue of over 860 incidents, this analysis examines patterns in AI-related harms including surveillance bias and discriminatory systems, illustrating how algorithmic surveillance can systematically target vulnerable populations.
- [The Age of Surveillance Capitalism — Shoshana Zuboff](https://www.hachettebookgroup.com/titles/shoshana-zuboff/the-age-of-surveillance-capitalism/9781610395694/) — Zuboff's influential analysis of how technology companies extract and monetize personal data provides the essential theoretical framework for understanding the economic forces driving the expansion of surveillance infrastructure into every domain of daily life.
