## "Should we let parents choose their children's genes?"
...
Heritable gene editing — actually modifying the DNA of embryos in ways that are passed to future generations — raises the stakes further. [He Jiankui's 2018 experiment](/md-files/p18_crispr_babies_embryo_selection.md) was condemned as premature and reckless, but it demonstrated that the capability exists. If the safety concerns are eventually addressed, the ethical questions remain: who decides what modifications are acceptable? And on what basis?

### What the Book Brings to This

The book's [Could We? Should We?](/md-files/rei_could_we_should_we.md) framework is at its most powerful here. The capability exists. The demand exists. The market exists. The question of whether it should proceed — and under what constraints — is being answered de facto by individual parents, fertility clinics, and startup companies rather than by any kind of collective deliberation.
...
The book's treatment of [Human Dignity](/md-files/rei_human_dignity.md) through [Never Let Me Go](/md-files/movies_never_let_me_go.md) asks what happens when human beings are treated as things to be optimized — created to serve purposes determined by others. The parallel to genetic selection is not exact (selected children are not clones grown for organ harvesting), but the underlying question rhymes: at what point does optimization become objectification?

### Explore Further

- [CRISPR Babies, Embryo Selection, and Heritable Gene Editing](/md-files/p18_crispr_babies_embryo_selection.md) — the technology in detail
- [Genetic Engineering and Gene Editing](/md-files/est_genetic_engineering.md) — the foundational science
- [Could We? Should We?](/md-files/rei_could_we_should_we.md) — the book's central ethical question
- [Informed Consent and Autonomy](/md-files/rei_informed_consent.md) — consent when the subject cannot speak
- [Human Dignity and What Makes Us Human](/md-files/rei_human_dignity.md) — optimization and objectification
- [The Role of Scientists and Innovators](/md-files/rei_role_of_scientists.md) — who bears responsibility for making this possible
