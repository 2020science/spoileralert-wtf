...
The book explored deception and manipulation through films like [Ex Machina](https://spoileralert.wtf/md-files/movies_ex_machina.md) and the broader theme of [Deception, Manipulation, and Convenient Lies](https://spoileralert.wtf/md-files/rei_deception_manipulation.md). What it could not have anticipated is the speed at which the tools of deception would become universally accessible.
...
### The Spectrum from Tool to Weapon
...
The book's framework for [Science, Belief, and Ways of Knowing](https://spoileralert.wtf/md-files/ntf_science_belief.md) — explored through [Contact](https://spoileralert.wtf/md-files/movies_contact.md) and the tension between evidence and faith — becomes urgently practical when the nature of evidence itself is undermined. See also [How do I know what's real anymore?](https://spoileralert.wtf/md-files/ceq_whats_real.md)

### Explore Further

- [LLMs and Frontier AI](https://spoileralert.wtf/md-files/p18_llms_frontier_ai.md) — the underlying AI systems that make synthetic media possible
- [AI-Generated Art and the IP Question](https://spoileralert.wtf/md-files/p18_ai_generated_art.md) — the creative dimension
- [Deception, Manipulation, and Convenient Lies](https://spoileralert.wtf/md-files/rei_deception_manipulation.md) — the book's ethical framework for navigating lies
- [Surveillance, Privacy, and Control](https://spoileralert.wtf/md-files/rei_surveillance_privacy_control.md) — what happens when synthetic media meets surveillance infrastructure
- [How do I know what's real anymore?](https://spoileralert.wtf/md-files/ceq_whats_real.md) — the broader epistemological question
- [Digital Resurrection, Grief Tech, and AI Companions of the Dead](https://spoileralert.wtf/md-files/p18_grief_tech.md) — shared technical infrastructure, applied in the most emotionally charged context
