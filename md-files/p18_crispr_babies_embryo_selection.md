...
- [Consumer Genomics and the Privatization of the Genome](https://spoileralert.wtf/md-files/p18_consumer_genomics.md) — the other axis of the genetic-data story: what happens to the dataset, not the germline
- [Xenotransplantation](https://spoileralert.wtf/md-files/p18_xenotransplantation.md) — another frontier of gene editing: CRISPR-edited pig organs transplanted into humans
