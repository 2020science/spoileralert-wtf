...
The book's [Informed Consent](https://spoileralert.wtf/md-files/rei_informed_consent.md) framework is severely strained. Being subject to algorithmic scoring is, for most people, not something they chose — it is a condition of participating in modern economic life. The [Surveillance, Privacy, and Control](https://spoileralert.wtf/md-files/rei_surveillance_privacy_control.md) dimension is equally clear: these scoring systems require vast amounts of personal data, creating surveillance infrastructure that persists whether or not the scoring is accurate or fair.

The question of whether algorithms can be more fair than human decision-makers is genuinely complex. Human hiring managers are biased too. Human loan officers discriminate. But the scale and opacity of algorithmic systems create a different kind of risk — one where bias is systematized, invisible, and difficult to correct. See [Should an algorithm be allowed to decide whether I get a job, a loan, or parole?](https://spoileralert.wtf/md-files/ceq_algorithmic_decisions.md)

### Explore Further

- [Predictive Algorithms and Machine Learning](https://spoileralert.wtf/md-files/est_predictive_algorithms.md) — the book's foundational treatment
- [Ubiquitous Surveillance and Big Data](https://spoileralert.wtf/md-files/est_surveillance.md) — the data infrastructure behind scoring
- [Surveillance, Privacy, and Control](https://spoileralert.wtf/md-files/rei_surveillance_privacy_control.md) — the ethical dimensions of pervasive monitoring
- [Facial Recognition and Biometric Surveillance](https://spoileralert.wtf/md-files/p18_facial_recognition.md) — the biometric dimension
- [Informed Consent and Autonomy](https://spoileralert.wtf/md-files/rei_informed_consent.md) — consent in systems you cannot opt out of
- [Should an algorithm be allowed to decide whether I get a job, a loan, or parole?](https://spoileralert.wtf/md-files/ceq_algorithmic_decisions.md) — the complex emerging question
- [Algorithmic Labor and Algorithmic Management](https://spoileralert.wtf/md-files/p18_algorithmic_labor.md) — the sibling P18 page on *ongoing* algorithmic authority over workers (as distinct from one-off gatekeeping decisions)
