## "These technologies don't stop at borders. How do we govern them?"
...
[Everyone Has a Role](/md-files/ntf_everyone_has_a_role.md) extends beyond individuals to nations and institutions. The book argues that technology governance cannot be left to any single group — not to scientists, not to corporations, not to governments. The international version of this argument is that governance cannot be left to any single country or bloc.

[Responsible Innovation in Practice](/md-files/ntf_responsible_innovation_practice.md) offers an approach that does not depend on international agreements (which may never come). It argues for embedding responsible practices into the innovation process wherever it occurs — through professional norms, institutional policies, and industry standards that cross borders even when regulation does not.

[Dual-Use Research and Biosecurity](/md-files/rei_dual_use_biosecurity.md) — developed through the book's discussion of [Inferno](/md-files/movies_inferno.md) and [gain-of-function research](/md-files/est_gain_of_function.md) — provides a model for thinking about technologies where the knowledge itself is the risk. Biosecurity governance has developed precisely because pathogens do not respect borders, and the lessons (both successes and failures) are transferable to other domains.

[Risk and Innovation](/md-files/ntf_risk_innovation.md) helps frame the trade-off. The goal is not to eliminate risk — that would mean eliminating innovation. The goal is to manage risk in ways that are proportionate, transparent, and accountable across jurisdictions. This is extremely difficult. It is also necessary.

### Explore Further

- [Autonomous Weapons and Lethal Autonomous Systems](/md-files/p18_autonomous_weapons.md) — where cross-border governance is most urgent
- [LLMs, Frontier AI, and Agentic Systems](/md-files/p18_llms_frontier_ai.md) — global technology, national regulation
- [Active Geoengineering Proposals](/md-files/p18_active_geoengineering.md) — altering the shared atmosphere
- [Pandemic Preparedness and Biosurveillance](/md-files/p18_pandemic_preparedness.md) — pathogens as a model for cross-border risk
- [Synbio Acceleration](/md-files/p18_synbio_acceleration.md) — AI-designed biology crossing borders
- [Dual-Use Research and Biosecurity](/md-files/rei_dual_use_biosecurity.md) — lessons from biosecurity governance
- [Can we regulate AI without killing the good parts?](/md-files/ceq_regulating_ai.md) — the domestic regulation counterpart
